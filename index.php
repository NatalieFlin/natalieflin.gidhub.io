...
<!-- 	<link rel="stylesheet" href="main.css">
 -->	</head>
    ...
    <div class="theme-button" id="theme-button">Сменить тему</div>
      ...
      <li><a href="#">Особенности моделей транспорта</a>
        <ul>
          <li><a href="#el">Электросамокат</a></li>
          <li><a href="#giro">Гироскутер</a></li>
          <li><a href="#sig">Сигвей</a></li>
        </ul>
      ...
      <li><a href="#">О нас</a>
       <ul>
          ...
          <li><a href="#aboutUs">Наши преимущества</a></li>
       </ul>
     </li>
    </ul>
